                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><button type="button" name ="delete" class="btn btn-danger" value ="Delete" data-bs-toggle="modal" data-bs-target="#deletemodal">Delete</button></td>
                            <div class="modal fade" tabindex="-1" id="deletemodal">
                                  ...
                                  <div class="modal-body">
                                    <p>Just click <strong>'Delete' </strong>To delete this appointment.</p>
                                  </div>
                                  <div class="modal-footer">
